    ...
    <aside className="hidden lg:flex flex-col w-64 shrink-0 bg-white border-r border-slate-200/80 min-h-screen shadow-[1px_0_0_rgba(0,0,0,0.03)]">
      ...
      <div className="flex items-center gap-3 px-5 h-16 border-b border-slate-100">
        ...
        <div>
          ...
          <p className="font-mono text-[9px] uppercase tracking-widest text-slate-400 mt-0.5">Legal Intelligence</p>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="rounded-xl bg-gradient-to-br from-indigo-50 to-violet-50 border border-indigo-100 p-3">
          <p className="font-mono text-[10px] text-indigo-600 font-semibold">v0.2.0 · Legal OS</p>
          <p className="font-mono text-[10px] text-indigo-400 mt-0.5">All systems operational</p>
